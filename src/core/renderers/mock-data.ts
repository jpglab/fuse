    ...
    logger.updateLog(getDeviceInfoId, {
        dataPhase: {
            ...
            encodedData: new Uint8Array([
                0x64, 0x00, 0x06, 0x00, 0x53, 0x00, 0x6f, 0x00, 0x6e, 0x00, 0x79, 0x00, 0x20, 0x00, 0x43, 0x00,
            ]),
            decodedData: {
                StandardVersion: 100,
                ...
                OperationsSupported: [
                    ...
                    0x100d, 0x100e, 0x100f, 0x1014, 0x1015, 0x1016, 0x101b, 0x9201, 0x9202, 0x9203,
                ],
                EventsSupported: [0x4001, 0x4002, 0x4003, 0x4004, 0x4005, 0x4006, 0xc201, 0xc202],
                DevicePropertiesSupported: [
                    0x5001, 0x5002, 0x5003, 0x5004, 0x5005, 0x5007, 0x5008, 0x500a, 0x500b, 0x500c, 0x500d, 0x500e,
                    0x500f, 0xd001, 0xd002,
                ],
